...
namespace AudioQualityChecker.Services
{
    public class DiscordRichPresenceService : IDisposable
    {
        ...
        public void Enable()
        {
            string clientId = AudioAuditorSettings.DiscordRpcClientId;
            ...
            TimeSpan? duration = null, TimeSpan? position = null, bool isPaused = false)
        {
            ...
            string displayMode = AudioAuditorSettings.DiscordRpcDisplayMode;
            bool showElapsed = AudioAuditorSettings.DiscordRpcShowElapsed;
        ...
        private static async Task FetchAlbumArtAsync(string artist, string title)
        {
            ...
            string apiKey = AudioAuditorSettings.LastFmApiKey;
